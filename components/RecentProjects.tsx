...
const RecentProjects = () => {
  ...
  const showMoreProjects = () => {
    router.push("/courses"); // Redirects to courses page
  };
  return (
    <div className="py-20" id="projects">
      <h1 className="heading">A Specially Designed professional
        {" "}
      ...
      <div className="flex justify-center">
        <Button onClick={showMoreProjects} className="px-6 py-3 rounded-full transition">Show More</Button>
      </div>
    </div>
  );  
};
