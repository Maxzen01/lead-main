...
import { FaShieldAlt, FaLock, FaUserShield, FaProjectDiagram, FaRegClock, FaCertificate, FaHandsHelping } from "react-icons/fa";
...
const CybersecurityPage = () => {
  ...
  const courseOverview = [
    ...
    "In-depth exploration of network security, encryption, and authentication.",
    "Hands-on labs with penetration testing, vulnerability assessments, and incident response.",
    "Preparation for leading certifications like CISSP, CEH, and CompTIA Security+."
  ];

  const keyHighlights = [
    { title: "Network Security", icon: <FaShieldAlt />, description: "Learn to secure networks and detect attacks." },
    { title: "Ethical Hacking", icon: <FaLock />, description: "Hands-on experience in penetration testing." },
    { title: "Certification", icon: <FaCertificate />, description: "Preparation for top cybersecurity certifications." },
    { title: "Job Assistance", icon: <FaHandsHelping />, description: "Placement support and career guidance." }
  ];
  ...
  return (
    <main className="dark:bg-gradient-to-r from-gray-900 to-black min-h-screen flex flex-col">
      ...
      <section className="container mx-auto px-5 py-10 flex-grow">
        <h1 className="text-4xl font-bold text-center mb-6 text-black dark:text-white">Cybersecurity</h1>
        ...
        <div className="flex flex-col md:flex-row gap-8 items-center">
          ...
          <p className="text-lg text-black dark:text-white mt-6 md:mt-0 md:w-2/3">
            Cybersecurity is essential in today’s digital world. Learn how to protect systems, networks, and data from cyber threats.
          </p>
        </div>
